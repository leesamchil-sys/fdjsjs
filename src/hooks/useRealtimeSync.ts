...
export function useRealtimeSync(
  ...
  useEffect(() => {
    ...
    const activeUnsubscribe = onSnapshot(userDocRef, (snapshot) => {
      ...
      const cloudOceanCleaningNames = new Set<string>(data.completedOceanCleaningNames || []);
      ...
      const cloudMasterOceanCleaningNames = new Set<string>(data.masterOceanCleaningNames || []);
