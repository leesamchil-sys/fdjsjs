...
export function useCollectionActions(
  ...
  const handleToggleFlowerColor = useCallback((itemId: string, variantKey: string) => {
    const updated = { ...flowerColorCollections };
    ...
    setFlowerColorCollections(updated);
  ...
  }, [flowerColorCollections, setFlowerColorCollections, markCollectionsModified, debouncedSyncAllData, user]);
