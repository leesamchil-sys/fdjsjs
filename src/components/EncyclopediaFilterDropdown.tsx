                                ...
                                <button
                                    onClick={() => {
                                        ...
                                        if (selectedSeasonFilters.length === 0 && SEASONAL_EVENTS.length > 0) {
                                            setSelectedSeasonFilters([SEASONAL_EVENTS[0].id]);
                                        }
                                    }}
                                    className={cn(
                                        ...
                                        {SEASONAL_EVENTS.map(season => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={cn(
                                                        "px-2.5 py-1 text-[11px] rounded-full transition-all font-semibold cursor-pointer border inline-flex items-center gap-1 w-auto shrink-0",
                                                        isSelected
