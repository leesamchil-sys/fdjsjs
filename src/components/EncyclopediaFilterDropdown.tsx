...
function EncyclopediaFilterDropdownComponent({
    collectionFilter,
    setCollectionFilter,
    starFilter,
    setStarFilter,
            ...
            <button
                ...
                className={cn(
                    ...
                    activeFilterCount > 0
                        ...
                        : "bg-white dark:bg-stone-900 border border-stone-300/70 dark:border-stone-800 text-stone-500 hover:text-stone-700 dark:text-stone-400 dark:hover:text-stone-200 hover:border-stone-400 dark:hover:border-stone-700 shadow-sm"
                )}
            >
...
export default memo(EncyclopediaFilterDropdownComponent);
