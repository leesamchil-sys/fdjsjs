...
interface InteractiveMapProps {
  ...
  onToggleCompletion?: (id: string, category?: any) => void;
...
export const InteractiveMap: React.FC<InteractiveMapProps> = React.memo(({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      const urlMapId = currentMapId === 'town' ? '고래섬' : '고래낙하협곡';
      const currentPath = location.pathname.startsWith('/map') || location.pathname === '/' || location.pathname === '' ? '/home' : location.pathname;
      ...
      const newUrl = currentPath + '?' + searchParams.toString() + location.hash;
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-1.5 shrink-0">
                                  {onToggleCompletion && (
                                    <button
                                      onClick={() => onToggleCompletion(creature.id, creature.dbType || creature.type || creature.mainCategory)}
