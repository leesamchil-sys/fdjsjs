...
const PriceTableComponent = ({ item, type, hidePrices, variant = 'default', forceDark = false }: { item: any, type?: Category | string, hidePrices?: boolean, variant?: 'default' | 'compact', forceDark?: boolean }) => {
