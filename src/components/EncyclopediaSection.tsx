    ...
    <>
      ...
      <section ref={filterRef} className="relative">
        ...
        <div ref={searchHeaderRef} className={cn(
          "sticky top-[var(--sticky-top-mobile)] lg:top-[var(--sticky-top-desktop)] -mx-4 sm:-mx-6 md:-mx-8 bg-neutral-50/95 dark:bg-stone-955/95 backdrop-blur-md px-4 sm:px-6 md:px-8 py-1.5 sm:py-2 md:py-3 border-b border-stone-200/35 dark:border-stone-900/40 shadow-xs font-scale-lock",
