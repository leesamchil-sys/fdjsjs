...
export default function EncyclopediaSection({
  ...
  const handleOpenIngredientModal = (ingName: string) => {
        ...
        {filteredItems.length > 0 ? (
          <>
            ...
            >
              ...
              {filteredItems.slice(0, visibleLimit).map((item: any) => (
                <div
                  key={item.id}
                  id={`card-${item.name}`}
                  className="h-full rounded-[32px] transition-all duration-700"
                  style={{
