      ...
      <div className="flex flex-col items-center gap-1 text-[10.5px] text-stone-400 font-medium font-sans">
        <div className="flex items-center gap-3 mb-1">
          <button 
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#FEE500] text-[#3C1E1E] rounded-full font-black text-[11px] hover:bg-[#FDD800] transition-all active:scale-95 shadow-sm"
          >
